...
/**
 * Lightweight inline SVG icon set (Lucide-style stroke icons).
 * Using real vector icons instead of emoji keeps the UI crisp and
 * consistent across platforms — emoji render differently on every OS.
 */
const PATHS = {
  // Padel paddle — the brand mark / "Play" tab
  racket: (
    <>
